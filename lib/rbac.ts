...
export const rolePermissions: RolePermissions = {
  ...
  sales: {
    ...
    bookingTokens: {
      ...
      update: false,
      delete: false,
      notes: "Can create and view own tokens",
    },
    enquiries: {
      component: "enquiries",
      create: true,
    ...
    tasks: {
      ...
      update: true,
      delete: false,
      notes: "View assigned only, can update own",
    },
    designAssignments: {
      component: "designAssignments",
      create: false,
  ...
  designer: {
    ...
    tasks: {
      ...
      update: true,
      delete: false,
      notes: "Design tasks only, can update own",
    },
    designAssignments: {
      component: "designAssignments",
      create: false,
...
export function canEditOwn(
  ...
  if (
    ...
    ["bookings", "enquiries"].includes(component)
  ) {
